...
export default function LoginScreen() {
  ...
  // No KeyboardAvoidingView here, unlike the iOS build: app.json asks for
  // `softwareKeyboardLayoutMode: "resize"`, so Android shrinks the window
  // when the keyboard opens and this ScrollView simply gets shorter. Adding
  // the view on top of that double-counts the inset and pushes the form off
  // the screen.
  return (
