...
import { Button, Card, EmptyState, Input, SectionHeading, Toggle } from './ui';
        ...
        return (
          <Card key={p.id} style={styles.logCard}>
            <View style={styles.logRow}>
              <Pressable onPress={() => setDetailItem(p)} style={styles.grow}>
                <Text style={styles.itemName} numberOfLines={1}>
                  {p.name}
                </Text>
              </Pressable>
      ...
      {scoped.map((s) => {
        ...
        return (
          <Card key={s.id} style={styles.logCard}>
            <View style={styles.logRow}>
              <Pressable onPress={() => setDetailItem(s)} style={styles.grow}>
                <Text style={styles.itemName} numberOfLines={1}>
                  {s.name}
                </Text>
              </Pressable>
...
const styles = StyleSheet.create({
  ...
  unitOption: { paddingHorizontal: 12, paddingVertical: 6, borderRadius: radius.md },
