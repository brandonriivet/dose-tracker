...
export default function SettingsScreen() {
  ...
  // Same idea, different field name per store: iOS has a build number
  // string, Android an integer versionCode.
  const build =
    (Platform.OS === 'ios'
  ...
  return (
    <Screen>
      ...
      {/* The web app's "App link" card doesn't exist here — an installed app
          has no URL to share. Version and build are the useful equivalent
          when you're checking which copy is on the phone. */}
      <Section title="App">
        <Card>
          <View style={styles.rowBetween}>
            <View style={styles.grow}>
